    ...
    public function prepareFilterParams($binds = [], $predicate = null)
    {
        ...
        if (is_array($binds)) {
            foreach ($binds as $v) {
                ...
                if (isset($v['nesting']) &&
                    (Constant\PredicateType::NEST === $v['nesting'] || Constant\PredicateType::UNNEST === $v['nesting'])
                ) {
                ...
                switch ($v['predicate']) {
                    case Constant\PredicateType::BETWEEN:
                    case Constant\PredicateType::NOT_BETWEEN:
                        ...
                        break;
                    case Constant\PredicateType::EQUAL_TO:
                    case Constant\PredicateType::NOT_EQUAL_TO:
                    case Constant\PredicateType::GREATER_THAN:
                    case Constant\PredicateType::LESS_THAN:
                    case Constant\PredicateType::GREATER_THAN_OR_EQUAL_TO:
                    case Constant\PredicateType::LESS_THAN_OR_EQUAL_TO:
                    case Constant\PredicateType::EQ:
                    case Constant\PredicateType::NEQ:
                    case Constant\PredicateType::GT:
                    case Constant\PredicateType::LT:
                    case Constant\PredicateType::GTE:
                    case Constant\PredicateType::LTE:
                        ...
                        break;
                    case Constant\PredicateType::EXPR:
                    case Constant\PredicateType::EXPRESSION:
                        ...
                        break;
                    case Constant\PredicateType::IN:
                    case Constant\PredicateType::NIN:
                    case Constant\PredicateType::NOT_IN:
                        ...
                        break;
                    case Constant\PredicateType::IS_NOT_NULL:
                    case Constant\PredicateType::IS_NULL:
                        ...
                        break;
                    case Constant\PredicateType::LIKE:
                    case Constant\PredicateType::NOT_LIKE:
