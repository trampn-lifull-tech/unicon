...
namespace Chaos\Common\Support\Factories\Doctrine;
...
use Chaos\Common\Support\Factories\Doctrine\Event\TablePrefix;
...
final class EntityManagerFactory // implements \Zend\ServiceManager\Factory\FactoryInterface
{
    ...
    private function getEventManager($prefix = null)
    {
        ...
        if (!empty($prefix)) {
            $eventManager->addEventListener(ORM\Events::loadClassMetadata, new TablePrefix($prefix));
